...
#pragma region PSO
	...
	rootParameters[0].Descriptor.ShaderRegister = 1;//Object3d.PS.hlsl の b0
	...
	rootParameters[2].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL; // VertexShaderを使う
